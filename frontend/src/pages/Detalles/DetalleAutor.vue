...
<script>
import ChartAuthorDetails from "@/components/Charts/chart-author-details";
...
export default {
  components: {
   ...
   data()
    ...
    mounted() {
    axios({ method: "GET", "url": "http://192.168.0.21:8082/book/author/" + this.$route.params.id }).then(result => {
